...
- `_talks/`: academic presentations. Use `title` for the conference and `presentation_title` for the paper/presentation.
- `_data/presentations.yml`: policy and industry presentations shown below the academic presentation list.
